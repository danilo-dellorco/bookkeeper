...
public class ReadMancio {
    ...
    public ReadMancio(TestInput testInput) {
    ...
    public void bufChWrTest() throws Exception {
    	...
    	System.out.println("buff size: " + this.buffChanCapacity);
    	System.out.println("read length: " + this.dataToRead);
    	System.out.println("isWrite: " + this.isWriteInFile);
